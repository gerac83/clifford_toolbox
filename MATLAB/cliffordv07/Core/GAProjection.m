function out = GAProjection(v, w)

%GAPROJECTION(V,W) calculate the projection of the vector v on the subspace
...
out = GeometricProduct(InnerProduct(v,w), MultivectorInverse(w));
